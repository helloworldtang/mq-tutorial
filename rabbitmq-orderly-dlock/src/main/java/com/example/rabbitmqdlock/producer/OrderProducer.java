package com.example.rabbitmqdlock.producer;
...
public class OrderProducer {
    ...
    public void sendOrderMessage(int orderId, String eventType, long version) {
        try {
            ...
            logger.info("DLock订单消息发送成功: orderId={}, eventType={}, routingKey={}, version={}",
                    orderId, eventType, routingKey, version);

        } catch (Exception e) {
            logger.error("DLock订单消息发送失败: orderId={}, eventType={}", orderId, eventType, e);
