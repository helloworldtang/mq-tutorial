...
import com.example.rabbitmqdlock.producer.OrderProducer;
...
@SpringBootTest(classes = RabbitMQDlockApplication.class)
public class OrderConsumerTest {
    ...
    public void testSingleOrderSequentialMessage() {
        ...
        System.out.println("✅ DLock测试通过：单个订单顺序消息处理正确");
    }
    ...
    public void testVersionFilter() {
        ...
        System.out.println("✅ DLock测试通过：版本号过滤正确");
    }
    ...
    public void testIdempotency() {
        ...
        System.out.println("✅ DLock测试通过：幂等性正确");
    }
    ...
    public void testInvalidStatusTransition() {
        ...
        System.out.println("✅ DLock测试通过：非法状态流转被正确拒绝");
    }
